	...
	$plugins = array(
		...
		// This is an example of how to include a plugin pre-packaged with a theme
                array(
                        ...
                        'source'   				=> 'https://downloads.wordpress.org/plugin/wp-retina-2x.5.0.5.zip', // The plugin source
                ...
                array(
                        ...
                        'source'   				=> get_template_directory_uri() . '/recommended_plugins/LayerSlider6.7.6.zip', // The plugin source
                        'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
                ...
                array(
                        ...
                        'source'   				=> get_template_directory_uri() . '/recommended_plugins/revslider5.4.8.1.zip', // The plugin source
                        'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
                ...
                array(
                        ...
                        'source'   				=> get_template_directory_uri() . '/recommended_plugins/js_composer5.6.zip', // The plugin source
                        'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
